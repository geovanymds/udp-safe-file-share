...
#define BUFFER_SIZE 480  //tamanho de cada pacote do arquivo
...
int main(int argc, char *argv[])
{
  ...
  for (int i = 2; i < argc; i++)
  {
    ...
    char palavra1[17];        //auxiliar para soma do checksum
    char palavra2[17];        //auxiliar para soma do checksum
    char wordAux[17];         //auxiliar para soma do checksum
